...
namespace PSK.Server.Migrations
{
    ...
    [Migration("20250520143303_SeedPermissions")]
            ...
            modelBuilder.Entity("PSK.Server.Data.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Can assign labels to job",
                            Name = "JobLabelAssign"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000005"),
                            Description = "Can create new board",
                            Name = "BoardCreate"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000006"),
                            Description = "Can update boards",
                            Name = "BoardUpdate"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Description = "Can create new label",
                            Name = "LabelCreate"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000009"),
                            Description = "Can update labels",
                            Name = "LabelUpdate"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Description = "Can invite people to team",
                            Name = "InvitationCreate"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000012"),
                            Description = "Can remove people from team",
                            Name = "TeamRemove"
                        },
                        new
                        {
